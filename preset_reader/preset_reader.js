	...
	// function got_xml_now_check_checkbox()
	// {
...
function got_preset_now_read()
{
                              ...
                              {  
                               ...
                               //  alert(x[i].getElementsByTagName("Phone")[0].getAttribute('Link') );
								...
								var global_dropdown_id = document.querySelector("#dropdown_vmat_file_preset_01a");
...
// Only read bg. This should ignore checklist
...
function got_preset_now_read_only_bg()
{
							  ...
							  // var def_bracks_cbox = $(global_dropdown_id).find("[mrk_crow=\"mrow17\"]");
									...
									// hmmm... load dif only ?? For now and demo purposes - yes. Moved to separate file. Dont forget to fix it
